...
export const DEFAULT_PERMISSIONS = [
  ...
  { key: "finance.customercollection.manage", description: "Collect payment, dispute, cancel, close, create installment plans, generate payment links, and send reminders for customer collections" },
