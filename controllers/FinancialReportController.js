...
export const exportReport = async (req, res) => {
  ...
  try {
    ...
    const exportResult = await FinancialReportExportService.exportAndStore(reportDoc, format, scope.tenantId);
    ...
    publishEvent("ReportExported", { tenantId: scope.tenantId, reportId: reportDoc._id.toString(), format, performedBy: userId || null });
