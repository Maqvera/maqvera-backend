...
const options = {
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        CreateUserRequest: {
          ...
          properties: {
            username: { type: "string", example: "JaneAgent" },
    ...
    tags: [
      ...
      { name: "Users & Employees", description: "User Accounts, Roles, Permissions & Invitations" },
      { name: "Customers", description: "Customer Profiles, Passports, Documents & Emergency Contacts" },
      { name: "Bookings", description: "Booking Management, Workflow States & Financial Summaries" },
      { name: "Travel Plans", description: "Itineraries & Travel Planning" },
      { name: "Visa Processing Engine", description: "Visa Cases, Requirements, Verification & Embassy Processing" },
      { name: "Flight & Hotel Distribution", description: "GDS Flight Search, Booking & Hotel Offers" },
      { name: "AI Travel Assistant", description: "AI Chat Assistant & Tool Orchestration" },
      { name: "Incidents & SLA", description: "Enterprise Incident & SLA Escalation Tracking" },
    ...
    paths: {
      ...
      "/auth/signup": {
        post: {
          ...
          responses: { 201: { description: "Signup successful" }, 409: { description: "User already exists" } },
        },
      },
      "/auth/login": {
        post: {
      ...
      "/auth/mfa/status": {
        get: {
          tags: ["Authentication"],
          summary: "Check current MFA status",
      ...
      "/auth/security": {
        get: {
          tags: ["Authentication"],
          summary: "Get Security Center metrics & active devices",
          responses: { 200: { description: "Security summary loaded" } },
        },
      },
      ...
      "/users": {
        get: {
          ...
          summary: "List all user accounts within tenant",
      ...
      "/users/{userId}/status": {
        patch: {
          tags: ["Users & Employees"],
          summary: "Update user status (active/suspended/inactive)",
          parameters: [{ name: "userId", in: "path", required: true, schema: { type: "string" } }],
          requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { status: { type: "string", example: "suspended" } } } } } },
      ...
      "/users/{userId}/role": {
        patch: {
          tags: ["Users & Employees"],
          summary: "Update assigned role for user",
          parameters: [{ name: "userId", in: "path", required: true, schema: { type: "string" } }],
      ...
      "/customers": {
        get: {
          ...
          responses: { 200: { description: "Customers list loaded" } },
        },
        post: {
          tags: ["Customers"],
      ...
      "/customers/{customerId}": {
        get: {
          ...
          responses: { 200: { description: "Customer profile loaded" } },
        },
        patch: {
          tags: ["Customers"],
      ...
      "/customers/{customerId}/emergency-contacts": {
        ...
        post: {
          tags: ["Customers"],
          summary: "Add customer emergency contact",
          parameters: [{ name: "customerId", in: "path", required: true, schema: { type: "string" } }],
      ...
      "/customers/{customerId}/passports": {
        get: {
          tags: ["Customers"],
          summary: "Get customer passport details",
          parameters: [{ name: "customerId", in: "path", required: true, schema: { type: "string" } }],
          responses: { 200: { description: "Passports loaded" } },
        },
        post: {
          tags: ["Customers"],
          summary: "Add new passport details",
          parameters: [{ name: "customerId", in: "path", required: true, schema: { type: "string" } }],
          responses: { 201: { description: "Passport added" } },
        },
      },
      ...
      "/bookings": {
        get: {
          ...
          responses: { 200: { description: "Bookings list loaded" } },
        },
        post: {
          tags: ["Bookings"],
      ...
      "/bookings/search": {
        get: {
          tags: ["Bookings"],
          summary: "Search bookings by reference, customer or type",
          responses: { 200: { description: "Search results returned" } },
        },
      },
      "/bookings/{bookingId}": {
      ...
      "/bookings/{bookingId}/travelers": {
        get: {
          ...
          parameters: [{ name: "bookingId", in: "path", required: true, schema: { type: "string" } }],
          responses: { 200: { description: "Travelers loaded" } },
        },
      },
      "/bookings/{bookingId}/financial-summary": {
        get: {
          tags: ["Bookings"],
          summary: "Get financial breakdown for booking",
          parameters: [{ name: "bookingId", in: "path", required: true, schema: { type: "string" } }],
          responses: { 200: { description: "Financial summary loaded" } },
        },
      },
      ...
      "/travel-plans": {
        get: {
          tags: ["Travel Plans"],
          summary: "List all travel itineraries",
      ...
      "/ai/orchestrate": {
        post: {
          tags: ["AI Travel Assistant"],
          summary: "AI Tool Execution & Multi-Step Orchestrator",
          responses: { 200: { description: "Orchestration completed" } },
        },
      },
      ...
      "/incidents": {
        ...
        post: {
          tags: ["Incidents & SLA"],
          summary: "Report new enterprise incident",
      ...
      "/incidents/{incidentId}/escalate": {
        patch: {
          tags: ["Incidents & SLA"],
          summary: "Escalate incident severity / level",
      ...
      "/search": {
        post: {
          ...
          summary: "Execute cross-module enterprise search query",
          requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { query: { type: "string", example: "Alice" } } } } } },
          responses: { 200: { description: "Search results returned" } },
        },
      },
      ...
      "/reference/airports": {
        get: {
          tags: ["Reference Data"],
          summary: "Get master airports reference list",
          responses: { 200: { description: "Airports reference list" } },
        },
      },
      "/reference/currencies": {
        get: {
          ...
          responses: { 200: { description: "Currencies reference list" } },
        },
      },
      "/reference/countries": {
        get: {
          ...
          responses: { 200: { description: "Countries reference list" } },
        },
      },
      ...
      "/timeline": {
        get: {
          tags: ["Notes & Audit Timeline"],
          summary: "List audit activity timeline",
